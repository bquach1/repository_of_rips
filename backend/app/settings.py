...
class Settings:
    ...
    def __post_init__(self) -> None:
        ...
        self.venmo_card_keywords = env_keyword_list(
            "VENMO_CARD_KEYWORDS",
            "(pkc|mamamia ragan|froakie|card|cards|tcg|pokemon|one piece|riftbound|booster|pack|box|single|slab|psa|bgs|cgc|prerelease|Pre release|whatnot|tcgplayer|collectr|rip|op\d{2,4}|op\d{2,4}-?\d{3,4}|Mr 3)",
        )
